import { percent, robot } from "../assets";
 ...
 return (
    ...
    {/*Animation image*/}
       <div className={`flex-1 ${styles.flexStart} md:my-0 my-10`}>
        <img src={robot} alt="robot" className="w-[100%] h-[100%] relative z-10"/>
       </div>
        ...
        <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6 relative`}>
            ...
            <div className="flex flex-row items-center py-[6px] px-4 rounded-[10px] mb-2 bg-slate-500 bg-discount-gradient">
                <img src={percent} alt="percent" className="w-[20px] h-[20px]"/>
                <p className={`${styles.paragraph} ml-2`}>
                <span className="text-white">20% </span> Chegirma  
                 <span className="text-white"> 1 Oylik</span> Xisob Uchun</p>
            </div>
              {/*Title*/}
            ...
            <p className={`${styles.paragraph} mt-5 max-w-[550px]`}>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa, esse! Deleniti et molestias pariatur ratione, 
                necessitatibus sint.
            </p>
             {/*Getting started*/}
               <Button styles={'mt-2'}/>
